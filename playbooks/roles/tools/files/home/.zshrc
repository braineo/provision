...
plugins=(git thefuck urltools pip zsh-syntax-highlighting gitfast zsh-completions autojump npm)

# User configuration

 export PATH=$PATH:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/usr/local/games:/usr/games:$HOME/bin
# export MANPATH="/usr/local/man:$MANPATH"

 source $ZSH/oh-my-zsh.sh

 # Git prompt display style
...
alias emacsapp="export LC_CTYPE=zh_CN.UTF-8 /usr/bin/local/emacs"
